...
sketches = quick_draw_data_set[random_number];
document.getElementById("sketch_to_be_drawn").innerHTML = "Sketch To be Drawn: " + sketches;
time_counter = 0;
time_check = "";
drawn_sketch = "";
answer_holder = "";
...
function check_sketch(){
    ...
    if(time_counter > 400){
        ...
        random_number1 = Math.floor((Math.random()*quick_draw_data_set.length)+1)
        console.log(quick_draw_data_set[random_number1])
        sketches1 = quick_draw_data_set[random_number1];
        document.getElementById("sketch_to_be_drawn").innerHTML = "Sketch To be Drawn: " + sketches1;
    }
